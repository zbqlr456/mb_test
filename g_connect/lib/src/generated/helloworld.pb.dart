...
class HelloRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HelloRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'helloworld'), createEmptyInstance: create)
    ...
    ..a<$core.int>(2, _omitFieldNames ? '' : 'id1', $pb.PbFieldType.O3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'id2', $pb.PbFieldType.OU3)
    ..e<ServiceStatus>(4, _omitFieldNames ? '' : 'stt', $pb.PbFieldType.OE, defaultOrMaker: ServiceStatus.INSVC, valueOf: ServiceStatus.valueOf, enumValues: ServiceStatus.values)
  ...
  @$pb.TagNumber(2)
  $core.int get id1 => $_getIZ(1);
  @$pb.TagNumber(2)
  set id1($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $core.int get id2 => $_getIZ(2);
  @$pb.TagNumber(3)
  set id2($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  ServiceStatus get stt => $_getN(3);
  @$pb.TagNumber(4)
  set stt(ServiceStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasStt() => $_has(3);
  @$pb.TagNumber(4)
  void clearStt() => clearField(4);
}
...
class HelloReply extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HelloReply', package: const $pb.PackageName(_omitMessageNames ? '' : 'helloworld'), createEmptyInstance: create)
